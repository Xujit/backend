package com.codingaxis.hr.security.jwt;
...
public class TokenProvider {
  ...
  @Inject
  public TokenProvider(TalencyProperties talencyProperties) throws Exception {

    this.key = readPrivateKey(talencyProperties.security().authentication().jwt().privateKey().location());
    this.issuer = talencyProperties.security().authentication().jwt().issuer();
    this.tokenValidityInMilliseconds = talencyProperties.security().authentication().jwt().tokenValidityInSeconds()
        * 1000;
    this.tokenValidityInMillisecondsForRememberMe = talencyProperties.security().authentication().jwt()
